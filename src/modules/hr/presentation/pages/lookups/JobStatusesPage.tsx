...
export function JobStatusesPage() {
  const { t } = useLanguage();
  const { entities: items, create, update, remove, loadingMap, errorMap, list } = useEntityCrud<JobStatus>('/hr/job-statuses', '/hr/job-statuses', { listState: true, defaultSortColumn: 'name', paginate: false, debounceMs: 300 });

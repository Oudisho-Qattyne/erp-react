        ...
        <>
          ...
          <Dialog isOpen={isCreateOpen} onClose={() => setIsCreateOpen(false)}
            ...
            <GenericCreateForm
              ...
              onSubmit={async (data) => { try { return await create({ ...data, name: { ar: data.name }, residence_city_id: selectedCity }); } catch (err) { toast.error(err?.message || t('lookups.create_error', 'hr').replace('{name}', entity)); throw {}; } }}

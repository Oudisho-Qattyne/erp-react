...
const investmentsModule: Module = {
  ...
  routes: [
    ...
    },
    {
      ...
      group: 'investments',
      requiredPermission: ['investments.industry-categories.list', 'investments.industry-types.list', 'investments.consumable-materials.list', 'investments.license-statuses.list', 'investments.industrial-decision-types.list', 'investments.industrial-license-sources.list', 'investments.by-duration-licenses.list', 'investments.by-industry-licenses.list', 'investments.rent-contract-industries.list'],
    },
    {

...
export interface ISubscriptionRepository {
  ...
  changeSubscriptionRequestStatus(plotId:number , subRequestId:number , status:string, idempotencyKey?: string) : Promise<DomainResponse<SubscriptionRequest>>
  completeSubscriptionRequest(plotId:number , subRequestId:number, idempotencyKey?: string) : Promise<DomainResponse<SubscriptionRequest>>

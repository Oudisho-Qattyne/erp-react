...
export function ServiceStatusConditionsPage() {
  const { t } = useLanguage();
  const { entities: items, create, update, remove, loadingMap, errorMap, list } = useEntityCrud<ServiceStatusCondition>(
    '/investments/service-status-conditions',
    '/investments/service-status-conditions',
  ...
  return (
    <div className="p-6 space-y-6">
      ...
      handleApiError(err, { module: "investments" }); throw err;
          ...
          onSuccess={() => { toast.success(t('service_status_conditions.created', 'investments').replace('{name}', entityName)); list.refresh(); setIsCreateOpen(false); }}

...
export function IndustrialLicenseSourcesPage() {
  ...
  const columns = [
    ...
    {
      key: 'is_active',
      label: t('industrial_license_sources.is_active', 'investments') || 'Active',
      width: 100,
    ...
    {
      key: 'is_default',
      label: t('industrial_license_sources.is_default', 'investments') || 'Default',
      width: 120,
        ...
        <GenericCreateForm
          ...
          onSubmit={async (data) => {
            try {
              ...
              toast.error(t('industrial_license_sources.create_error', 'investments').replace('{name}', entityName)); throw {};
            }
          }}

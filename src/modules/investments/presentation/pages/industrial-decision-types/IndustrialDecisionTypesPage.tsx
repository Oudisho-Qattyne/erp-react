...
export function IndustrialDecisionTypesPage() {
  ...
  const handleDeleteConfirm = async () => {
    ...
    try {
      ...
      toast.error(err?.message || t('industrial_decision_types.delete_error', 'investments').replace('{name}', entityName));
    }
  ...
  return (
    <div className="p-6 space-y-6">
      ...
      toast.error(err?.message || t('industrial_decision_types.create_error', 'investments').replace('{name}', entityName)); throw err;
    }
          }}

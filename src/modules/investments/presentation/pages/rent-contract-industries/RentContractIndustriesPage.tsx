...
export function RentContractIndustriesPage() {
  ...
  const handleDeleteConfirm = async () => {
    ...
    try {
      ...
      toast.error(err?.message || t('rent_contract_industries.delete_error', 'investments').replace('{name}', entityName));
    }
  ...
  return (
    <div className="p-6 space-y-6">
      ...
      toast.error(err?.message || t('rent_contract_industries.create_error', 'investments').replace('{name}', entityName)); throw err;
    }
          }}

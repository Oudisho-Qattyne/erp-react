...
export function ByDurationLicensesPage() {
  ...
  const handleDeleteConfirm = async () => {
    ...
    try {
      ...
      toast.error(t('by_duration_licenses.delete_error', 'investments').replace('{name}', entityName));
    }
  ...
  const columns = [
    ...
    {
      key: 'is_active',
      label: t('by_duration_licenses.is_active', 'investments') || 'Is Active?',
      width: 120,
    ...
    {
      key: 'is_default',
      label: t('by_duration_licenses.is_default', 'investments') || 'Default',
      width: 120,
        ...
        <GenericCreateForm
          ...
          onSubmit={async (data) => {
            try {
              ...
              toast.error(t('by_duration_licenses.create_error', 'investments').replace('{name}', entityName)); throw {};
            }
          }}

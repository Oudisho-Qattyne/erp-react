...
export function ByIndustryLicensesPage() {
  ...
  const handleDeleteConfirm = async () => {
    ...
    try {
      ...
      toast.error(t('by_industry_licenses.delete_error', 'investments').replace('{name}', entityName));
    }
        ...
        <GenericCreateForm
          ...
          onSubmit={async (data) => {
            try {
              ...
              toast.error(t('by_industry_licenses.create_error', 'investments').replace('{name}', entityName)); throw {};
            }
          }}

...
export function ByIndustryLicensesPage() {
  ...
  const handleDeleteConfirm = async () => {
    ...
    try {
      ...
      toast.error(err?.message || t('by_industry_licenses.delete_error', 'investments').replace('{name}', entityName));
    }
  ...
  return (
    <div className="p-6 space-y-6">
      ...
      toast.error(err?.message || t('by_industry_licenses.create_error', 'investments').replace('{name}', entityName)); throw err;
    }
          }}
